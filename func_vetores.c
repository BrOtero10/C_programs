...
void ordenar_subordinado_vfloar(float vetor_dominante[], float vetor_subordinado[], int elem){
...
double busca_maior_vint(int vetor[], int inicio, int final){
...
double busca_maior_vfloat(float vetor[], int inicio, int final){
...
double busca_maior_vdouble(double vetor[], int inicio, int final){
